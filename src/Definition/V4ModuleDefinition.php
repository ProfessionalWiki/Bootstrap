...
class V4ModuleDefinition implements ModuleDefinition {
	...
	static private $moduleDescriptions = [
		...
		'variables'         => [ 'styles' => 'variables', 'dependencies' => 'functions' ],
		...
		'dropdown'          => [ 'styles' => 'dropdown', 'scripts' => 'dropdown', 'dependencies' => [ 'popper', 'js-util' ] ],
		...
		'carousel'          => [ 'styles' => 'carousel', 'scripts' => 'carousel', 'dependencies' => 'js-util' ],
		'utilities'         => [ 'styles' => 'utilities' ],
		'print'             => [ 'styles' => 'print' ],
		'active-buttons'    => [ 'scripts' => 'button', 'dependencies' => [ 'buttons' ] ],
		'dismissable-alert' => [ 'scripts' => 'alert', 'dependencies' => [ 'alert', 'js-util' ] ],
		...
		'bs-all'    => [ 'dependencies' => [
			...
			'progress', 'media', 'list-group', 'close', 'modal', 'tooltip',
			'popover', 'carousel', 'utilities', 'print', 'active-buttons',
