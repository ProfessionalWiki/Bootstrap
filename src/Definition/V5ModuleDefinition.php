...
/**
 * Class describing the Bootstrap 5 module definitions
 *
 * @since 6.0
 * @ingroup   Bootstrap
 */
class V5ModuleDefinition implements ModuleDefinition {
	...
	private static $moduleDescriptions = [
		...
		'card'              => [ 'styles' => 'card' ],
		'accordion'         => [ 'styles' => 'accordion', 'dependencies' => 'collapse' ],
		...
		'offcanvas'         => [ 'styles' => 'offcanvas', 'dependencies' => 'base-component' ],
